function [X, W, opt, time, iter, support, numActive] = QUIC(mode, S, L, tol, msg, maxIter, X0, W0)
% [X W opt time iter support numActive] = QUIC("default", S, L, tol, msg, maxIter, X0, W0)
% [X W opt time iter support numActive] = QUIC("trace", S, L, tol, msg, maxIter, X0, W0)
%
% Arguments:
